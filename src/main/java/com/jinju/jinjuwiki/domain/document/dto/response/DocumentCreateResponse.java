...
public record DocumentCreateResponse(
        @Schema(description = "생성된 문서 ID", example = "42")
        Long documentId,
        @Schema(description = "생성된 문서 제목", example = "진주성 전투")
        String title,
        @Schema(description = "생성된 문서 요약", example = "임진왜란 당시 진주성에서 벌어진 전투를 정리한 문서")
        String summary,
